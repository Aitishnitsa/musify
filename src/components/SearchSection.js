    ...
    return (<>
        <Container title={""} className={'col-span-3'}>
            <form action="" class="relative mx-auto">
                <input type="search"
                    class="peer cursor-pointer relative z-10 h-12 rounded-full border bg-white opacity-25 pl-12 outline-none w-full" />
                <div className="flex items-center h-full">
                    <svg xmlns="http://www.w3.org/2000/svg"
                        class="text-white absolute inset-y-0 h-10 w-12 border-r border-transparent px-3"
